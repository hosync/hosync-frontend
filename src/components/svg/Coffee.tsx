...
const SVG: FC<Props> = ({
  ...
  >
    <svg
      width={size || width}
      height={size || height}
      viewBox="0 0 365.793 365.793"
      fill={alternativeColor || color}
      xmlns="http://www.w3.org/2000/svg"
    >
      <g>
        <path
          d="M322.318,167.785c-2.473-8.789-9.652-14.467-18.29-14.467H261.05l1.438-17.493l0.012-0.285
        ...
        />
        <path
          d="M149.122,93.303c0.983,0.668,2.136,1.021,3.333,1.021h0.013c3.277,0,5.943-2.665,5.943-5.94c0-0.56-0.077-1.113-0.23-1.648
        ...
        />
        <path
          d="M202.403,89.118c0.926,0.63,2.006,0.963,3.125,0.963h0.006c3.071,0,5.569-2.499,5.569-5.569
        ...
        />
        <path
          d="M96.266,89.115c0.926,0.632,2.008,0.967,3.129,0.967h0.006c3.07,0,5.568-2.499,5.568-5.569c0-0.514-0.07-1.022-0.21-1.515
